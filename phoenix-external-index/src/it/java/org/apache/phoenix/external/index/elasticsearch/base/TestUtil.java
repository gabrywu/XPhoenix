...
import static org.apache.phoenix.external.index.elasticsearch.base.BaseTest.generateUniqueName;
...
public class TestUtil {
   ...
   public static void analyzeTable(String url, Properties props, String tableName) throws IOException, SQLException {
    ...
    public static void assertIndexInfoMetadata(ResultSet rs, String schemaName, String dataTableName, String indexName, int colPos, String colName, Order order) throws SQLException {
        assertTrue(rs.next());
    ...
    public static void assertIndexInfoMetadata(ResultSet rs, String schemaName, String dataTableName, String indexName, int colPos, String colName, Order order, int type) throws SQLException {
        assertTrue(rs.next());
        assertEquals(null,rs.getString(1));
        assertEquals(schemaName, rs.getString(2));
        assertEquals(dataTableName, rs.getString(3));
    ...
    public static void assertActiveIndex(Connection conn, String schemaName, String tableName) throws SQLException {
    ...
    public static void assertNoActiveIndex(Connection conn, String schemaName, String tableName) throws SQLException {
        ImmutableBytesWritable ptr = new ImmutableBytesWritable();
        String fullTableName = SchemaUtil.getTableName(schemaName, tableName);
        conn.createStatement().executeQuery("SELECT count(*) FROM " + fullTableName).next(); // client side cache will update
        PhoenixConnection pconn = conn.unwrap(PhoenixConnection.class);
    ...
    public static void printMetadata(PhoenixResultSetMetaData metaData) throws SQLException{
    ...
    public static void printResult(PhoenixConnection connection,String query,String message) throws SQLException{
        printResult(connection.createStatement().executeQuery(query),message);
    }
    public static void printResult(ResultSet rs,String message) throws SQLException {
    ...
    public static void printTableColumns(PhoenixConnection connection,String tableName,String message) throws SQLException{
        ResultSet rs = connection.getMetaData().getColumns ("",
                null,
                tableName,
                null);
        TestUtil.printResult(rs,message);
    }
}
