...
public class ColumnMappingUtils {
    ...
    public static Map<String, Integer> getReverseColumnIndex(String columnMapping) {
        Map<String, Integer> phoenix2HiveColumnIndex = new LinkedHashMap<>();
        Map<String, String> forward = getColumnMappingMap(columnMapping);
        int i = 0;
        for(Map.Entry<String, String> entry : forward.entrySet()){
            phoenix2HiveColumnIndex.put(entry.getValue(), i++);
        }
        return phoenix2HiveColumnIndex;
    }
}
