...
public class PhoenixResultWritable implements Writable, DBWritable, Configurable {
    ...
    private Map<String, Integer> phoenix2HiveColumnIndex;
    ...
    public void write(PreparedStatement statement) throws SQLException {
        ...
        try {
            for (int i = 0, limit = columnMetadataList.size(); i < limit; i++) {
                ...
                int valueIndex = phoenix2HiveColumnIndex.get(columnInfo.getDisplayName());
    ...
    public void setConf(Configuration conf) {
        ...
        this.phoenix2HiveColumnIndex = ColumnMappingUtils.getReverseColumnIndex(config.get(PhoenixStorageHandlerConstants.PHOENIX_COLUMN_MAPPING,""));
