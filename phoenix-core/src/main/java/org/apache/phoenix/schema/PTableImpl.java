...
public class PTableImpl implements PTable {
    ...
    private MutationState.RowTimestampColInfo rowTimestampColInfo;
    public PTableImpl() {
        this.indexes = Collections.emptyList();
        this.physicalNames = Collections.emptyList();
        this.rowKeySchema = RowKeySchema.EMPTY_SCHEMA;
        this.rowTimestampColInfo = null;
    }
    ...
    @Override
    public MutationState.RowTimestampColInfo getRowTimestampColInfo(){
        return rowTimestampColInfo;
    }
    @Override
    public void setRowTimestampColInfo(MutationState.RowTimestampColInfo rowTimestampColInfo){
        this.rowTimestampColInfo = rowTimestampColInfo;
    }
