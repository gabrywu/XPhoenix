...
public interface PTable extends PMetaDataEntity {
    ...
    public enum IndexType {
        ...
        public static IndexType fromToken(String token) {
            return token.isEmpty() ? getDefault():IndexType.valueOf(token.trim().toUpperCase());
        }
    ...
    MutationState.RowTimestampColInfo getRowTimestampColInfo();
    void setRowTimestampColInfo(MutationState.RowTimestampColInfo rowTimestampColInfo);
