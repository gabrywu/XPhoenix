...
public class QueryServicesOptions {
    ...
    public QueryServicesOptions set(String name, boolean value) {
        config.set(name, Boolean.toString(value));
        return this;
    }

    public QueryServicesOptions set(String name, int value) {
        config.set(name, Integer.toString(value));
        return this;
    }

    public QueryServicesOptions set(String name, String value) {
        config.set(name, value);
        return this;
    }

    public QueryServicesOptions set(String name, long value) {
