...
public class PhoenixIndexMetaData implements IndexMetaData {
    ...
    private final boolean hasExternalIndexes;
    ...
    public PhoenixIndexMetaData(IndexMetaDataCache indexMetaDataCache, Map<String, byte[]> attributes) throws IOException {
        ...
        boolean hasExternalIndexes = false;
        for (IndexMaintainer maintainer : indexMetaDataCache.getIndexMaintainers()) {
            ...
            hasExternalIndexes |= maintainer.getIndexType()== PTable.IndexType.EXTERNAL;
        }
        ...
        this.hasExternalIndexes = hasExternalIndexes;
    }
    ...
    public boolean hasExternalIndexes() {
        return hasExternalIndexes;
    }
    @Override
