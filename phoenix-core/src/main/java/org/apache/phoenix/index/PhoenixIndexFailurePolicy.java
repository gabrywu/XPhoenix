...
public class PhoenixIndexFailurePolicy extends DelegateIndexFailurePolicy {
    ...
    public void setup(Stoppable parent, RegionCoprocessorEnvironment env) {
        ...
        boolean killServer = env.getConfiguration().getBoolean(QueryServices.INDEX_FAILURE_KILL_SERVER, false);
        if (!killServer) {
            String changePolicyMsg = "Change KillServerOnFailurePolicy to LeaveIndexActiveFailurePolicy";
            LOG.warn(changePolicyMsg);
            super.stop(changePolicyMsg);
